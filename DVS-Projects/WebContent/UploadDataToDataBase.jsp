...
<body class="backGround">
	...
	<form action="http://localhost:8080/DVS-Projects/UploadDataToDataBase" method="post" enctype="multipart/form-data">
			<div>
	...
	<%
				...
				File imageDir = new File("C:/git/UploadedPictures/");
			...
			<div style="max-width: 400px; padding-left: 30%;"  >
				<td>
					...
					%><br/> 
					<img src="C:/git/UploadedPictures/<%=i %>" Style="float: center; width:100%;height:100%;"/> 
