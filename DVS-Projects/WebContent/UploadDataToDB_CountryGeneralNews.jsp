...
<body class="backGround">
	...
	<form action="http://localhost:8080/DVS-Projects/UploadDataToDB_CountryGeneralNews" method="post" enctype="multipart/form-data">
			<div>
	...
	<%
				...
				File imageDir = new File("C:/git/COUNTRYPHOTOS/");
			...
			<div style="max-width: 400px; padding-left: 30%;"  >
				<td>
					...
					%><br/> 
					<img src="C:/git/COUNTRYPHOTOS/<%=i %>" Style="float: center; width:100%;height:100%;"/> 
